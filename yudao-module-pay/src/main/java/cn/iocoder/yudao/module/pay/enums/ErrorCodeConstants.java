...
public interface ErrorCodeConstants {
    ...
    // ========== 支付风险评估 1-007-010-000 ==========
    ErrorCode PAY_RISK_ASSESS_IP_MISSING = new ErrorCode(1_007_010_000, "未能获取用于风控评估的 IP");
    ErrorCode PAY_RISK_ASSESS_IPINFO_TOKEN_MISSING = new ErrorCode(1_007_010_001, "未配置 ipinfo token");
    ErrorCode PAY_RISK_ASSESS_DEEPSEEK_API_KEY_MISSING = new ErrorCode(1_007_010_002, "未配置 DeepSeek API Key");
